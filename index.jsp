 ...
 <div id="container"> 
        ...
        <div class="tab-pane fade" id="completedTasks">
            ...
            <c:forEach var="tempStudent1" items="${tasksList1}">
		 			...
		 			<td id="completedTaskName"> <a href="#" id="completeTaskDialog" onclick="test('${tempStudent1.parkingReason}','${tempStudent1.simLink}');">${tempStudent1.taskName}</a></td>
 ...
 <div class="modal fade" id="completedTask" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        <%-- <c:forEach var="tempStudent" items="${tasksList}">
                    <input type="hidden" name="parkingReason" id="parkingReason" value="${tempStudent.parkingReason}" />
...
<script>
 ...
 --%> /* $(".modal-body #parkedReason").val( parkingReason );
	...
	// Show/hide the parked reason textarea based on selected status
	 ...
	 function test(parkingReason, simLink) {
		 console.log(simLink)
